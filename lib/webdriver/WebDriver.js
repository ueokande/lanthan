...
class WebDriver {
  ...
  async click(sessionId, elementId) {
    await request({
      url: `${this.endpoint}/session/${sessionId}/element/${elementId}/click`,
      method: 'POST',
      json: {},
    });
  }
  ...
  async dismissAlert(sessionId) {
    await request({
      url: `${this.endpoint}/session/${sessionId}/alert/dismiss`,
      method: 'POST',
      json: {},
    });
  }

  async acceptAlert(sessionId) {
    await request({
      url: `${this.endpoint}/session/${sessionId}/alert/accept`,
      method: 'POST',
      json: {},
    });
  }

  async getAlertText(sessionId) {
    let response = await request({
      url: `${this.endpoint}/session/${sessionId}/alert/text`,
      method: 'GET',
      json: {},
    });
  ...
  async sendAlertText(sessionId, text) {
    await request({
      url: `${this.endpoint}/session/${sessionId}/alert/text`,
      method: 'POST',
      json: { text },
